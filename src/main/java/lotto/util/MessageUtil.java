...
import static lotto.enums.message.InputMessage.BONUS_INPUT;
import static lotto.enums.message.InputMessage.BUY_INPUT;
import static lotto.enums.message.InputMessage.WINNING_INPUT;
import static lotto.enums.message.OutputMessage.BUY_COUNT;
import static lotto.enums.message.OutputMessage.RATE;
import static lotto.enums.message.OutputMessage.WINNING_STATISTICS;
import static lotto.enums.message.OutputMessage.WINNING_STATISTICS_BONUS_RESULT;
import static lotto.enums.message.OutputMessage.WINNING_STATISTICS_RESULT;
